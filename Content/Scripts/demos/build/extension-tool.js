...
function headerDesign() {
    ...
    let widget = ReactUMG.wrap(React.createElement(
        'div',
        null,
        React.createElement('uJavascriptMultiBox', { CommandList: commandList, OnHook: onHook }),
        React.createElement(
            'div',
            null,
...
function design() {
    ...
    return instantiator(UMG.div({ $link: elem => {
